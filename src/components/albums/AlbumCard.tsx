// AlbumCard component - Displays a single album with actions
...
export function AlbumCard({ album, onEdit, onDelete }: AlbumCardProps) {
    ...
    return (
        <>
            <div className="album-card bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden group">
                {/* Album thumbnail/preview area */}
                <Link
                    to={`/albums/${album.id}`}
                    className="block aspect-video bg-gradient-to-br from-blue-50 to-indigo-100 relative"
                >
