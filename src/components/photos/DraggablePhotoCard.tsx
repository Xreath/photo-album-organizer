// DraggablePhotoCard - Photo card with drag-and-drop support
...
export function DraggablePhotoCard({ photo, thumbnailUrl, onView, onDelete, onSetCover }: DraggablePhotoCardProps) {
    ...
    return (
        <>
            <div
                ref={setNodeRef}
                style={style}
                className={`group relative aspect-square bg-gray-100 rounded-lg overflow-hidden ${isDragging ? 'shadow-lg ring-2 ring-blue-500' : ''
                    }`}
            >
                {/* Skeleton loader */}
                ...
                {/* Drag indicator */}
                <div className="absolute top-2 left-2 p-1.5 bg-white/90 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none">
